...
(function(){
  ...
  function printStyle(){
    ...
    res += `
      ...
      .lunar-card { position: relative; isolation: isolate; }
      ...
      .show_dao_tet { absolute; top: 0; right: 0; display: flex; text-align: center; width: clamp(100px, 3.5vw, 140px); align-items: center; justify-content: center; z-index: 3; }
      ...
      .ngan_cach { font-family: 'Be Vietnam Pro', sans-serif; color: var(--user-element-base-color, #ffffff); opacity: 0.9; font-size: clamp(10px, 0.8vw, 14px); text-align:center; }
      .phan_cach { font-family: 'Be Vietnam Pro', sans-serif; color: var(--user-element-base-color, #ffffff); opacity: 0.9; vertical-align: middle; text-align:center; font-size: clamp(10px, 0.8vw, 14px); padding-top: 6px; padding-bottom: 6px; }
      .nam_top { font-family: 'Bebas Neue', sans-serif; padding: 0 5px; color: var(--lc-text-main); bottom: -8px; font-size: clamp(20px, 2.0vw, 26px); font-weight:bold; text-align:center; text-shadow: var(--lc-text-shadow-light); }
      .thang_top, .thang_top_EN { font-family: 'Be Vietnam Pro', sans-serif; color: var(--lc-text-main); font-size: clamp(12px, 1.1vw, 18px); line-height:120%; border-top-left-radius: 16px; border-top-right-radius: 16px; padding-top: 15px; position: relative; overflow: visible; }
      .thang_top { text-align:right; }
      .thang_top_EN { text-align:left; }
      .todayduonglich { color: var(--lc-text-main); font-family:'Bebas Neue', sans-serif; text-align:center; font-size: clamp(140px, 17vw, 170px); line-height: 0.9; letter-spacing: 3px; font-weight: 600; text-shadow: var(--lc-text-shadow-heavy); position: relative; overflow: visible; cursor: pointer; }
      .thongtin_letet { font-family: 'Playfair Display', serif; color: var(--lc-holiday-color); line-height: 1.5; padding: 6px; margin:10px 30px 0px 30px; text-align:center; font-size: clamp(12px, 1.1vw, 18px); letter-spacing: 0.7px; background: var(--lc-bg-overlay); border-radius:14px; border:0.4px solid var(--lc-border-color); box-shadow: var(--lc-element-shadow); backdrop-filter: blur(8px); -webkit-backdrop-filter: blur(8px); text-shadow: var(--lc-text-shadow-light); font-weight: 500;}
      .cadaotucngu { font-family: 'Playfair Display', serif; font-style:italic; color: var(--lc-cadao-color); line-height: 1.5; padding: 6px; margin:10px 30px; text-align:center; font-size: clamp(12px, 1.1vw, 18px); letter-spacing: 0.7px; background: var(--lc-bg-overlay); border-radius:14px; border:0.4px solid var(--lc-border-color); box-shadow: var(--lc-element-shadow); backdrop-filter: blur(8px); -webkit-backdrop-filter: blur(8px); text-shadow: var(--lc-text-shadow-light); }
      .thutrongtuan, .thutrongtuan_EN { font-family: 'Playfair Display', serif; color: var(--lc-text-main); background: var(--lc-bg-overlay); box-shadow: var(--lc-element-shadow); backdrop-filter: blur(4px); -webkit-backdrop-filter: blur(4px); text-align:center; vertical-align: middle; font-size: clamp(19px, 2.1vw, 26px); line-height: 1.1; font-weight:bold; padding: 6px; text-shadow: var(--lc-text-shadow-light); position: relative; z-index: 1;}
      ...
      .svg_td { text-align:center; width:clamp(50px, 8vw, 80px); position: relative; z-index: 5; transition: z-index 0.1s; }
      ...
      .thang_am_lich, .nam_am_lich { position: relative; overflow: visible; color: var(--lc-text-accent); width: 38%; font-family: 'Playfair Display', serif; background: var(--lc-bg-overlay); box-shadow: var(--lc-element-shadow); backdrop-filter: blur(4px); -webkit-backdrop-filter: blur(4px); text-align:center; vertical-align: middle; font-size: clamp(16px, 1.8vw, 20px); line-height: 1.1; font-weight:bold; padding: 6px; margin: 10px auto; border-radius: 8px; text-shadow: var(--lc-text-shadow-light); }
      .ngayamlich { color: var(--lc-text-accent); font-family: 'Playfair Display', serif; text-align:center; vertical-align: middle; font-size: clamp(90px, 12vw, 120px); letter-spacing: 3px; font-weight: 600; text-shadow: var(--lc-text-shadow-heavy); margin: 10px auto; cursor: pointer; }
      .ThangNgayGioTiet_before { font-family:'Bebas Neue', sans-serif; font-style:italic; color: var(--lc-text-main); text-align:center; font-size: clamp(6px, 0.8vw, 10px); padding: 1px auto; margin: 6px auto 1px auto; text-shadow: var(--lc-text-shadow-light);}
      .ThangNgayGioTiet_after { font-family: 'Playfair Display', serif; color: var(--lc-text-accent); text-align:center; font-size: clamp(10px, 1vw, 16px); font-weight:bold; padding: 1px auto; margin: 1px auto 6px auto; text-shadow: var(--lc-text-shadow-light);}
      ...
      .ngaytuan, .ngaytuan_t7, .ngaytuan_cn { width:14%; text-align:center; font-size: 90%; padding: 6px 0; border-bottom: 1px solid var(--lc-border-color) !important;}
