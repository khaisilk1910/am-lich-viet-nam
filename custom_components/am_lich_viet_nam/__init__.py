...
async def async_setup(hass: HomeAssistant, config: dict) -> bool:
    ...
    add_extra_js_url(hass, f"{UI_URL_BASE}/lich-block-am-duong-viet-nam.js?v=6.0") # <--- Thẻ hiện lịch block
    add_extra_js_url(hass, f"{UI_URL_BASE}/su-kien-am-lich-card.js?v=6.0") # <--- Thẻ hiện danh sách đếm ngược sự kiện
    return True
